 ...
 */
package com.wukongzou.chinarentalbicyclemap.marker;
...
import com.wukongzou.chinarentalbicyclemap.R;
...
public class ClusterIconProvider implements IconDataProvider {
	...
	private static final int[] forCounts = { 10, 50, 100, 500, Integer.MAX_VALUE };
	...
	public ClusterIconProvider(Resources resources) {
		...
		paint.setTextSize(resources.getDimension(R.dimen.cluster_marker_text_size));
	}
